...
class Solver:
    ...
    def solve(self, ran_seed, collect_data=False, verbose=False):
        ...
        self.input_vector = [0.0 for i in range(2)]
        ofis = 0
        ...
        modelresultsW = open('./original_results.csv', 'a', newline='')
        writerMR = csv.writer(modelresultsW)
        writerMR.writerow([filename,ran_seed,OF_x_0,OF_x_best,OF_x_0-OF_x_best,time.time() - starting_time,diffiterationvectnew])
        modelresultsW.close()
