...
rf_models = {  "GreedyRepairCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_GreedyRepairCustomer.joblib"),
                "GreedyDestroyCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_GreedyDestroyCustomer.joblib"),
                "WorstDistanceDestroyCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_WorstDistanceDestroyCustomer.joblib"),
                "WorstTimeDestroyCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_WorstTimeDestroyCustomer.joblib"),
                "RandomRouteDestroyCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_RandomRouteDestroyCustomer.joblib"),
                "ZoneDestroyCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_ZoneDestroyCustomer.joblib"),
                "DemandBasedDestroyCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_DemandBasedDestroyCustomer.joblib"),
                "TimeBasedDestroyCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_TimeBasedDestroyCustomer.joblib"),
                "ProximityBasedDestroyCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_ProximityBasedDestroyCustomer.joblib"),
                "ShawDestroyCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_ShawDestroyCustomer.joblib"),
                "GreedyRouteRemoval" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_GreedyRouteRemoval.joblib"),
                "ProbabilisticWorstRemovalCustomer" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_ProbabilisticWorstRemovalCustomer.joblib"),
                "DeterministicBestRepairStation" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_DeterministicBestRepairStation.joblib"),
                "ProbabilisticBestRepairStation" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_ProbabilisticBestRepairStation.joblib"),
                "RandomDestroyStation" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_RandomDestroyStation.joblib"),
                "LongestWaitingTimeDestroyStation" : joblib.load("../ML-results-MultiClassModels-4way/random_forest_LongestWaitingTimeDestroyStation.joblib")
                # 
                # 
                }
...
class Solver:
    ...
    def solve(self, ran_seed, collect_data=False, verbose=False):
        ...
        modelresultsW = open('./model_results_4way.csv', 'a', newline='')
    ...
    def apply_destroy_and_repair(self, x: Solution, iteration: int):
        ...
        if (iteration % self.configs["number_iterations_station_removal"]) == 0:
            ...
            elif "Normal" in predicts.values():
                station_destroy = random.choice([i for i in predicts if predicts[i][0]=="Normal"])
            else:
        ...
        if iteration == 1:
            ...
            for move in moves_list["customer_repair"].keys():
                loaded_rf = joblib.load("D:\\Univ\\Laurea Magistrale\\Big Data Analytics and Machine Learning\\Progetto\\random_forest_" + move + ".joblib")
                predicts[''+move] = loaded_rf.predict(input_vector_2D)
            print(predicts)
